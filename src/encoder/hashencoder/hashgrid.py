# copy paste from here: https://github.com/Ruyi-Zha/naf_cbct/tree/main/src/encoder/hashencoder
...
class HashEncoder(nn.Module):
    ...
    def forward(self, inputs, size=1):
        ...
        # Clamp inputs to valid range to handle slight out-of-bound values
        inputs = torch.clamp(inputs, -size, size)
